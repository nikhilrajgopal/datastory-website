...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-kebqldpC.js
var server_kebqldpC_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-U9_N6fGh.mjs");
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_kebqldpC_exports as t };

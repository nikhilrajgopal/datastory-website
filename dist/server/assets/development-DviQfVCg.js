			...
			/* @__PURE__ */ jsxs("main", {
				...
				children: [
									...
									children: /* @__PURE__ */ jsxs(Reveal, {
										...
										children: [
											...
											/* @__PURE__ */ jsx("div", {
												...
												children: JCP_IMAGES.map((item, i) => /* @__PURE__ */ jsx("img", {
													src: item.src,
													alt: item.alt,
													loading: "lazy",
											...
											/* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsx("div", {
													...
													children: JCP_IMAGES.map((item, i) => /* @__PURE__ */ jsx("button", {
														type: "button",
														onClick: () => setSlide(i),
					...
					/* @__PURE__ */ jsx("section", {
						...
						children: /* @__PURE__ */ jsx("div", {
							className: "shell",
							children: PROGRAMS.map((program, i) => /* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("article", {
								tabIndex: 0,
					...
					/* @__PURE__ */ jsx("section", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs("p", {
								...
								children: AWARDS.map((award, i) => /* @__PURE__ */ jsx(Reveal, {
									delay: i * 80,
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [
											...
											/* @__PURE__ */ jsx("div", {
												className: "flex flex-wrap gap-2 sm:gap-3",
												children: ALUMNI.map((a, i) => /* @__PURE__ */ jsx("button", {
													type: "button",
													onClick: () => setAlum(i),
													title: a.name,
